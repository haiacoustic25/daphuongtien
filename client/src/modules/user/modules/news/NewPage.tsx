...
import { CategoriContext } from '../../../../context/CategoriContext';
...
const NewPage = () => {
  ...
  const { value } = useContext(CategoriContext);
  ...
  const resultSearch = () => {
    ...
    return posts.filter((it) => it.category.id === value);
  };
  ...
  return (
    <LayoutFullUser>
      <div className="flex">
        <div className="w-[calc(20%-100px)] sticky top-[10px] ml-[50px] mr-[20px] my-[20px] shadow-sm rounded-sm p-4 h-[500px]">
